<?php
//order_check xml process between merchant and eClubStore
...
if($result!='' || $result!==false) {
	...
	//
	//if SysMessage display transaction_code_not_found, you may rerun order_submission.php
